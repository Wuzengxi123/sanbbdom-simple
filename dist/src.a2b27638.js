...
var patch = (0, _init.init)([_class.classModule]);
var container = document.getElementById('container'); // 生成vnode

var vnode = (0, _h.h)('ul#list', {}, [(0, _h.h)('li.item', {}, ['默认节点', (0, _h.h)('button.del', {}, '删除当前项')])]); // 初次渲染,把vnode的内容全部添加到空白的容器中

patch(container, vnode);
document.getElementById('add').addEventListener('click', function () {
  // 生成新的vnode
  var newVnode = (0, _h.h)('ul#list', {}, [(0, _h.h)('li.item', {}, ['默认节点', (0, _h.h)('button.del', {}, '删除当前项')]), (0, _h.h)('li.item', {}, [Math.random() * 10, (0, _h.h)('button.del', {}, '删除当前项')])]); // 再次渲染,对比new vnode 和 old vnode,将真正需要渲染的部分进行渲染,不需要渲染的部分,不会更改 
